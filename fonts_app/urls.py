...
urlpatterns = [
    ...
    path(
        "get-license/<int:pk_font>/", GetFontLicensesView.as_view(), name="get_license"
    ),
    path(
    ...
    path(
        ...
        UserOrdersAnalyticsView.as_view(),
